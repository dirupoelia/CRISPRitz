...
def callHelp():
    ...
    print("help:",
          ...
          "\n\tcrispritz annotate-results <guidesFile> <resultsFile> <annotationsPathFile> <outputFile> -exons <exonsbedFile> -introns <intronsbedFile> -ctcf <ctcfbedFile> -dnase <dnasebedFile> -promoters <promotersbedFile>",
